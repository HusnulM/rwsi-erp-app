...
class Cost_model{
    ...
    public function getCostDetailByVersion($bomid, $version){
        $this->db->query("SELECT * FROM v_detailcost where bomid='$bomid' AND bom_version='$version'");
        return $this->db->resultSet();
    }
    ...
    public function save($data){
        try {
            ...
            $query1 = "INSERT INTO t_cost01(bomid,bom_version,partnumber,createdon,createdby)
                            VALUES(:bomid,:bom_version,:partnumber,:createdon,:createdby)";
            ...
            $query2 = "INSERT INTO t_cost02(bomid,bom_version,activity,partnumber,quantity)
                       VALUES(:bomid,:bom_version,:activity,:partnumber,:quantity)";
    ...
    public function deleteVersion($bomid,$version){
        $this->db->query('DELETE FROM t_cost01 WHERE bomid=:bomid AND bom_version=:bom_version');
        $this->db->bind('bomid',$bomid);
