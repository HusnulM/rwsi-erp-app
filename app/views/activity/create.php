                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="cycletime" id="cycletime" class="form-control" placeholder="Cycle Time" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="cycleunit" id="cycleunit" class="form-control" placeholder="Cycle Unit" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
