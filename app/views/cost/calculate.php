                                        ...
                                        <tfoot id="tbl-pr-footer">
                                            <tr>
                                                <td colspan="4" style="text-align:right;"> 
                                                    <h5>Total Waktu Process (detik)</h5>
                                                </td>
                                                <td style="text-align:right;"> 
                                                    <h5><?= number_format($data['totalwaktu'], 2, ',', '.'); ?></h5>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" style="text-align:right;"> 
                                                    <h5>Total Waktu Process (jam)</h5>
                                                </td>
                                                <td style="text-align:right;"> 
                                                    <h5><?= number_format($data['totalwaktu']/3600,4,',','.'); ?></h5>
                                                </td>
                                            </tr>
                                            <?php if($data['showcost']['rows'] > 0): ?>
                                            <tr>
                                                <td colspan="4" style="text-align:right;"> 
                                                    <h5>Upah Pekerja : <?= number_format($data['upah'],0,',','.'); ?></h5>
                                                </td>
                                                <td style="text-align:right;"> 
                                                    <h5><?= number_format($data['upah']/20/8,0,',','.'); ?></h5>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                                ...
                                                <td style="text-align:right;"> 
                                                    <h5><?= number_format($data['totalcost'],2,',','.'); ?></h5>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
    ...
    <script>
        ...
        $(function(){
            ...
            // appendCostItem();
            function appendCostItem(costdtl){
            ...
            $('#bomVersion').on('change', function(){
                ...
                loadCostItem(bomid, selectedVersion)
            });

            function loadCostItem(_bomID, _bomVersion){
                $.ajax({
                    url:base_url+'/cost/loaddetailcost/'+_bomID+'/'+_bomVersion,
                    method:'get',
                    dataType:'JSON',
                    contentType: false,
                    cache: false,
