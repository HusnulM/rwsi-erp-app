        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?= BASEURL; ?>/customer/save" method="POST">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="custname">Nama Customer</label>
                                                <input type="text" name="custname" id="custname" class="form-control" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="kodecust" id="kodecust" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="custtelp" id="custtelp" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
