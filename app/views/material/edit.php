                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="inp_stdpriceusd" id="inp_stdpriceusd" class="form-control" placeholder="Standard Price" value="<?= number_format($data['material']['stdpriceusd'], 4, ',', '.'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="inp_stdpricejpy" id="inp_stdpricejpy" class="form-control" placeholder="Standard Price JPY" value="<?= number_format($data['material']['price_jpy'], 4, ',', '.'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="inp_topprice" id="inp_topprice" class="form-control" placeholder="TOP Price" value="<?= number_format($data['material']['topprice'], 0, ',', '.'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="inp_toppriceusd" id="inp_toppriceusd" class="form-control" placeholder="TOP Price USD" value="<?= number_format($data['material']['toppriceusd'], 4, ',', '.'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="inp_toppricejpy" id="inp_toppricejpy" class="form-control" placeholder="TOP Price JPY" value="<?= number_format($data['material']['topprice_jpy'], 4, ',', '.'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php else : ?>
