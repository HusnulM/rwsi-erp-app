                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <input type="text" name="partnumber" id="partnumber" class="form-control" value="<?= $data['matnumber']; ?>" required readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                            <input type="text" name="drawingpn" id="drawingpn" class="form-control"/>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                            <input type="text" name="orignpn" id="orignpn" class="form-control" />
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn1" id="eqpn1" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn2" id="eqpn2" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn3" id="eqpn3" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn4" id="eqpn4" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn5" id="eqpn5" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn6" id="eqpn6" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn7" id="eqpn7" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn8" id="eqpn8" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn9" id="eqpn9" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn10" id="eqpn10" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn11" id="eqpn11" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xm-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                        <input type="text" name="eqpn12" id="eqpn12" class="form-control"/>
                                        </div>
                                        <span class="input-group-addon">
