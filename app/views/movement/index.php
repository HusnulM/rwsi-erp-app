                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 hideHeader">
                                        <div class="form-group">
                                            <div class="form-line">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="note" id="hdrtext">No Surat Jalan / Invoice</label>
    ...
    <script>
        ...
        $(function(){
            ...
            function readpoitem(ponum){
                // checkporelstat
                $.ajax({
                    url: base_url+'/movement/checkporelstat/'+ponum,
                    type: 'GET',
                    dataType: 'json',
                    cache:false,
                    success: function(result){
                        ...
                        if(result.approvestat == "1" || result.approvestat == "3"){
                            ...
                            $.ajax({
                                url: base_url+'/po/getopenpoitem/'+ponum,
                                type: 'GET',
                                dataType: 'json',
                                cache:false,
                                success: function(result){
                ...
                for(var i=0;i<_data.length;i++){
                    ...
                    html = `
                        <tr counter="`+ count +`" id="tr`+ count +`">
                            ...
                            <td> 
                                <input type="text" name="itm_qty[]" counter="`+count+`" id="inputqty`+count+`"  class="form-control inputNumber inputQty" style="width:100px; text-align:right;" required="true" value="`+ formatRupiah(quantity,'') +`" />
                            </td>
                            <td> 
                                <input type="text" name="itm_unit[]" counter="`+count+`" id="unit`+count+`" class="form-control" style="width:80px;" required="true" value="`+ _data[i].unit +`" readonly/>
                            </td>
                            <td> 
                                <input type="text" name="itm_whs[]" class="form-control checkWhsAuth" style="width:100px;" counter="`+count+`" id="whs`+count+`" required value="`+ _data[i].fromwhs +`"/>
                            </td>
                            <td class="reservasi"> 
                                <input type="text" name="itm_whs2[]" class="form-control" style="width:100px;" counter="`+count+`" id="whs2`+count+`" required value="`+ _data[i].towhs +`"/>
                            </td>
                            <td> 
                ...
                $("#btn-post").attr("disabled", true);
                    ...
                    $.ajax({
                        ...
                        if(result.msgtype === "1"){
                            ...
                            showErrorMessage(JSON.stringify(data))   
                            console.log(data)                      
                            $("#btn-post").attr("disabled", false);   
                        }
                    })
