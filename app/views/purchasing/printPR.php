...
$pdf->Cell(190,7,'PURCHASE REQUISTION',0,1,'C');
 
    $pdf->SetFont('Arial','B',10);
    $pdf->Cell(10,7,'',0,1);
    $pdf->Cell(20,5,'Tanggal',0);
    $pdf->Cell(4,5,':',0);
    $pdf->Cell(70,5, $data['header']['requiredDate'],0);

    $pdf->Cell(25,5,'Project',0);
    $pdf->Cell(4,5,':',0);
    $pdf->Cell(72,5,$data['header']['namaproject'],0);

    $pdf->Cell(10,7,'',0,1);
    $pdf->Cell(20,5,'No. PR',0);
    $pdf->Cell(4,5,':',0);
    $pdf->Cell(70,5,$data['header']['prnum'],0);

    $pdf->Cell(25,5,'Created By',0);
    $pdf->Cell(4,5,':',0);
    $pdf->Cell(72,5,$data['header']['createdBy'],0);

$pdf->Cell(10,7,'',0,1);
$pdf->SetFont('Arial','',8);
$pdf->Cell(8,6,'No',1,0);
$pdf->Cell(30,6,'Item Code',1,0);
...
$pdf->Cell(22,6,'Total Price',1,1,'R');
    ...
    foreach($data['pritem'] as $row) :
        ...
        $pdf->Cell(30,($line * $cellHeight),$row['ItemCode'],1,0);       
