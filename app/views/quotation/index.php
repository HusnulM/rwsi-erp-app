                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4" id="content-bom-version">
                                        <label for="bomversion">BOM Version</label>
                                        <select name="bomversion" id="find-version" class="form-control"></select>
                                    </div>
                                    <div class="col-lg-4">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#btn-view-quotation').on('click', function(){
                ...
                var bomVersion = $('#find-version').val();
                // alert(_topprice)

                $('#tbl-data-body, #tbl-data-footer').html('');
                $.ajax({
                    url: base_url+"/quotation/previewquotation/"+bomid+"/"+profit+"/"+_ppnchecked+'/'+bomVersion,
                    type: 'GET',
                    dataType: 'json',
                    cache:false,
            ...
            function loaddatapart(){
                ...
                $('#list-part tbody').on( 'click', 'button', function () {
                    ...
                    loadBomVersion(selected_data.bomid);
                    ...
                    $('#find-version').select2({ 
                        placeholder: 'Type Version',
                        width: '100%',
                        minimumInputLength: 0,
                        ajax: {
                            url: base_url + '/quotation/bomversoinlist/'+selected_data.bomid,
                            dataType: 'json',
                            delay: 250,
                            data: function(data){
                                return{
                            ...
                            processResults: function (data) {
                                ...
                                return {
                                    results: $.map(data.data, function (item) {
                                        // console.log(item);
                                        return {
                                            text: item.bom_version + ' - Created Date (' + item.createdon + ')',
                                            slug: item.bom_version,
                                            id: item.bom_version,
                                            ...item
                                        }
                                    })
            ...
            $('#btn-generate').on('click', function(){
                ...
                if(qdate === ""){
                    ...
                    window.open(base_url+"/quotation/generatequotation/"+bomid+"/"+qdate+"/"+profit+"/"+_ppnchecked+"/"+_topprice+'/'+bomVersion, '_blank');
                }
            });
            ...
            function loadBomVersion(_bomID){
                // bomversoinlist
                // $('#content-bom-version').html('');
                // $.ajax({
                //     url: base_url+'/quotation/bomversoinlist/'+_bomID,
                //     type: 'GET',
                //     dataType: 'json',
                //     cache:false,
                //     success: function(result){
                ...
                // }).done(function(result){
                //     console.log(result);
                //     $('#content-bom-version').append(`
                //         <label for="bomversion">BOM Version</label>
                //         <select name="bomversion" id="bomversion" class="form-control">
