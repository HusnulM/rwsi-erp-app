                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="reqdate1">Tanggal</label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            <button type="button" id="btn-process" class="btn btn-primary"  data-type="success">Tampilkan Data</button>
                                        </div>    
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        $(function(){
            $('#btn-process').on('click', function(){
                window.location.href = base_url+'/reports/bukubankview/'+$('#strdate').val()+'/'+$('#enddate').val()
            })
        })
    </script>