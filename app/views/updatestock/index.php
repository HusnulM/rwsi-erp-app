                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" name="updateby" id="updateby" value="<?= $_SESSION['usr_erp']['user']; ?>" readonly>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <ul class="pull-right">    
                                        ...
                                        <a href="<?= BASEURL; ?>" class="btn bg-red">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="barangModal">ADD Material</h4>
                        </div>
    ...
    <script>
        ...
        $(function(){
            ...
            function loaddatabarang(){
                ...
                //     "ajax": base_url+'/barang/listbarangwithstock',
                //     "columns": [
                //         { "data": "material" },
                //         { "data": "matdesc" },
                //         { "data": "partnumber" },
                ...
                $('#list-barang tbody').on( 'click', 'button', function () {
                    ...
                    html = `
                        <tr counter="`+ count +`" id="tr`+ count +`">
                            ...
                            <td> 
                                <input type="text" name="itm_remark[]" counter="`+count+`" id="remark`+count+`"  class="form-control" style="width:150px;" required="true" />
                            </td>
                            <td>
